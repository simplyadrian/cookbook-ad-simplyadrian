...
default['ad-nativex']['sssd_ldap']['auth_provider'] = 'krb5'
default['ad-nativex']['sssd_ldap']['chpass_provider'] = 'krb5'
...
default['ad-nativex']['sssd_ldap']['authconfig_params'] = '--enablesssd --enablesssdauth --enablelocauthorize --enablemkhomedir --update'
default['ad-nativex']['sssd_ldap']['access_provider'] = 'ad'
...
# Debug
default['ad-nativex']['sssd_ldap']['debug_level'] = 9 # TODO: Change to 0
