default['ad-nativex']['sssd_ldap']['id_provider'] = 'ldap'
...
default['ad-nativex']['sssd_ldap']['cache_credentials'] = 'false'
...
default['ad-nativex']['sssd_ldap']['ldap_user_object_class'] = 'posixAccount'
default['ad-nativex']['sssd_ldap']['ldap_user_name'] = 'uid'
...
default['ad-nativex']['sssd_ldap']['ldap_group_object_class'] = 'posixGroup'

default['ad-nativex']['sssd_ldap']['ldap_id_use_start_tls'] = 'true'
default['ad-nativex']['sssd_ldap']['ldap_tls_reqcert'] = 'never'
default['ad-nativex']['sssd_ldap']['ldap_tls_cacert'] = value_for_platform_family('rhel' => '/etc/pki/tls/certs/ca-bundle.crt', 'default' => '/etc/ssl/certs/ca-certificates.crt')
...
default['ad-nativex']['sssd_ldap']['authconfig_params'] = '--enablesssd --enablesssdauth --enablelocauthorize --update'

default['ad-nativex']['sssd_ldap']['access_provider'] = nil # Should be set to 'ldap'
default['ad-nativex']['sssd_ldap']['ldap_access_filter'] = nil # Can use simple LDAP filter such as 'uid=abc123' or more expressive LDAP filters like '(&(objectClass=employee)(department=ITSupport))'
